...
> it the T6 oracle reaches k = 1.000 at ≥ 4 px — its residual was the pass (`S2_T6_GATE.md` §8). With the
> backward field too (`mvb1=`, §9) the oracle is byte-exact on flat content and **T6's gate PASSES**.
