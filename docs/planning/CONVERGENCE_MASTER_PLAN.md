...
> M-R1 `records/R1_GATE.md`, M-R2 `records/R2_GATE.md`, **M-R3 `records/R3_GATE.md` (2026-09-05, gate PASSED (residual attributed))**, **M-R4 `records/R4_GATE.md` (2026-09-05, gate PASSED except the forced-TDR item (built, awaiting the operator's word))**); R5+ not built**; every "exists / line N /
