  ...
  **`active`** (host decision 2026-09-03) · boundaries = [`STAGE_CONTRACT.md`](STAGE_CONTRACT.md)
  ...
  - **S4.R7** closing · **TWO HALVES, tracked separately (2026-09-06)**
    - **R7(a)** `--legacy-warp` out of the default: M1 baselines on BOTH paths (S2.T4–T5) + MR-4 byte-diff +
      MR-8 operator eye = M-R7 · `measured 2026-09-06, the decision is the operator's` — **corrected the same
