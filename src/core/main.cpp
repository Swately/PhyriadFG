...
int main(int argc, char** argv) {
    ...
    char strack_buf[24]={}; if(cfg.single_track) std::snprintf(strack_buf,sizeof(strack_buf),cfg.st_no_stasis?" single-track(v3.0)":" single-track(v3.1)");   // v3 pre-store B-track override (v3.1 = +stasis re-admission, the shipping candidate; v3.0 = pure blend-solo-2 mirror)
